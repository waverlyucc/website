...
$output = '<div class="overlay-view-lightbox-buttons overlay-hide theme-overlay textcenter">';
	...
	$output .= '<div class="overlay-table clr">';
		...
		$output .= '<div class="overlay-table-cell clr">';
			...
			$output .= '<a href="'. $lightbox_link .'" class="' . $lightbox_class . '"' . $lightbox_data . '><span class="ticon ticon-search" aria-hidden="true"></span></a>';

			$output .= '<a href="'. $link .'" class="view-post"' . $target . '><span class="ticon ticon-arrow-right" aria-hidden="true"></span></a>';
