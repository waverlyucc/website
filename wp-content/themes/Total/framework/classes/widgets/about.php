	...
	class WPEX_About_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				...
				<textarea class="widefat" rows="5" cols="20" id="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'description' ) ); ?>"><?php echo wp_kses_post( $instance['description'] ); ?></textarea>
			</p>
