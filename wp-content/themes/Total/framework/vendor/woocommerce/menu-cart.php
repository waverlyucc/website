...
function wpex_add_header_menu_cart_item( $items, $args ) {
	...
	if ( apply_filters( 'woo_mobile_menu_cart_link', true )
		...
		$items .= '<li class="menu-item wpex-mm-menu-item"><a href="' . esc_url( get_permalink( $cart_id ) ) . '"><span class="link-inner">' . esc_html( wpex_get_mod( 'woo_menu_cart_text', __( 'Cart', 'total' ) ) ) . '</span></a></li>';
	}
...
if ( ! function_exists( 'wpex_wcmenucart_menu_item' ) ) {
	function wpex_wcmenucart_menu_item() {
		...
		$cart_text  = wpex_get_mod( 'woo_menu_cart_text', __( 'Cart', 'total' ) );
