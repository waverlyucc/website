...
class WPEX_Visual_Composer_Config {
	...
	public static function hide_vc_buttons_media_library() {
		...
		$hide_types = array( 'attachment', 'acf', 'wpex_sidebars', 'acf-field-group', 'elementor_library' );
		$hide_types = apply_filters( 'wpex_admin_hide_vc_editor_post_types', $hide_types );
